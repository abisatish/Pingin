...
Revision ID: 2f53a1e7c221
Revises: 
Create Date: 2025-07-04 14:18:30.460969
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['related_application_id'], ['collegeapplication.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['application_id'], ['collegeapplication.id'], ),
    sa.ForeignKeyConstraint(['consultant_id'], ['consultant.id'], ),
    sa.ForeignKeyConstraint(['essay_id'], ['essayresponse.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
