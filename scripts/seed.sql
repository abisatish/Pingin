...
/* ───────── consultants ────────────────────────────────────────────── */
INSERT INTO consultant (id,email,name,bio,tags,password_hash) VALUES
...
VALUES
 (1,100,
  ...
  NULL,NULL,
  'Female','HUNDRED_TO_200K'::incomebracket,FALSE,'US_CITIZEN'::citizenshipstatus,'NO'::underrepresentedgroup,
  NOW(),NOW()),
 ...
 (2,101,
  ...
  NULL,NULL,
  'Male','FIFTY_TO_100K'::incomebracket,TRUE,'US_CITIZEN'::citizenshipstatus,'YES'::underrepresentedgroup,
  NOW(),NOW()),
 ...
 (3,102,
  ...
  NULL,NULL,
  'Female','OVER_200K'::incomebracket,FALSE,'US_PERMANENT_RESIDENT'::citizenshipstatus,'NO'::underrepresentedgroup,
  NOW(),NOW()),
 ...
 (4,103,
  ...
  NULL,NULL,
  'Male','HUNDRED_TO_200K'::incomebracket,FALSE,'US_CITIZEN'::citizenshipstatus,'NO'::underrepresentedgroup,
  NOW(),NOW()),
 ...
 (5,104,
  ...
  NULL,NULL,
  'Female','UNDER_50K'::incomebracket,TRUE,'US_CITIZEN'::citizenshipstatus,'YES'::underrepresentedgroup,
  NOW(),NOW()),
 ...
 (6,105,
  ...
  NULL,NULL,
  'Non-binary','OVER_200K'::incomebracket,FALSE,'US_CITIZEN'::citizenshipstatus,'NO'::underrepresentedgroup,
  NOW(),NOW());
...
VALUES
 ...
 (2,100,1,'Stanford University','Computer Science','STEM'::majorcategory,
  'DRAFT'::collegeapplicationstatus,92,NOW(),NOW()),
 ...
 (5,101,2,'New York University (NYU)','Business Administration','BUSINESS'::majorcategory,
  'DRAFT'::collegeapplicationstatus,91,NOW(),NOW()),
 ...
 (8,102,4,'Duke University','Biology','STEM'::majorcategory,
  'DRAFT'::collegeapplicationstatus,93,NOW(),NOW()),
...
VALUES
 (1,1,
  ...
  TRUE,'["FIRST Robotics"]',
  NULL,NULL,
  'Female',NULL,FALSE,NULL,NULL,NOW(),NOW()),

 (2,2,
  '["Economics","Business / Entrepreneurship","Political Science"]',
  '["DECA","Model UN"]',
  FALSE,'["Debate or Speech","Student Government"]',
  NULL,NULL,
